...
import { addUSer, deleteuser, getUSer, getUSerbypk, getUsers, updateuser, obtenerconversacion, obtenermensajes, crearconversacion, enviarmensaje, getUSerbyName, obtenerultimaconversacion} from "../controllers/Controladores";
const router = Router()
...
router.get('/obtenerultimaconversacion/:iduser', obtenerultimaconversacion)
